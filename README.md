...
**Created by Methane_Intoxication**

[![Live Demo](https://img.shields.io/badge/demo-Live%20Site-success?style=flat-square&logo=github&logoColor=white)](https://Methane_Intoxication.github.io/gemini-watermark-remover/)
...
**🔗 Live Website:** [https://Methane_Intoxication.github.io/gemini-watermark-remover/](https://Methane_Intoxication.github.io/gemini-watermark-remover/)
...
* **Batch Removal:** Allows for batch processing of images and also batch download of images via a Zip File.
...
### Option 2: Python (or using the included script)
If you have Python installed, you can simply double-click the `run_server.bat` file included in this folder.
